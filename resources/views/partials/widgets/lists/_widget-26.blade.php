...
<div class="card card-flush h-lg-50">
	...
	<div class="card-body pt-5">
		...
		<div class="d-flex flex-stack">
			...
			<!--end::Section-->
			<!--begin::Action-->
			<button type="button" class="btn btn-icon btn-sm h-auto btn-color-gray-400 btn-active-color-primary justify-content-end">{!! getIcon('exit-right-corner', 'fs-2') !!}</button>
			<!--end::Action-->
		</div>
		<!--end::Item-->
		<!--begin::Separator-->
