			...
			<div class="tab-pane fade" id="kt_chart_widget_8_week_tab" role="tabpanel">
				...
				<div class="mb-5">
					...
					<div class="d-flex align-items-center mb-2">
						...
						<span class="badge badge-light-success fs-base"><?php echo getIcon('arrow-up', 'fs-5 text-success ms-n1'); ?> 4,8%</span>
					</div>
					<!--end::Statistics-->
					<!--begin::Description-->
			...
			<div class="tab-pane fade active show" id="kt_chart_widget_8_month_tab" role="tabpanel">
				...
				<div class="mb-5">
					...
					<div class="d-flex align-items-center mb-2">
						...
						<span class="badge badge-light-success fs-base"><?php echo getIcon('arrow-up', 'fs-5 text-success ms-n1'); ?> 2.2%</span>
					</div>
					<!--end::Statistics-->
					<!--begin::Description-->
					<span class="fs-6 fw-semibold text-gray-400">Avarage cost per interaction</span>
...
<!--end::Chart widget 8--><?php /**PATH D:\Ibiidi Materials\Metronic Theme Laravel\laravel_demo1\starterkit\resources\views/partials/widgets/charts/_widget-8.blade.php ENDPATH**/ ?>