			...
			<table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-end pe-0">
							<!--begin::Label-->
							<span class="badge badge-light-danger fs-base"><?php echo getIcon('arrow-down', 'fs-5 text-danger ms-n1'); ?> 0.4%</span>
							<!--end::Label-->
						</td>
						<td class="text-end pe-12">
...
<!--end::Table widget 14-->
<?php /**PATH D:\Ibiidi Materials\Metronic Theme Laravel\laravel_demo1\starterkit\resources\views/partials/widgets/tables/_widget-14.blade.php ENDPATH**/ ?>