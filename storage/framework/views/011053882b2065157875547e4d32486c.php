...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	<!--begin::Logo image-->
	<a href="/">
		<img alt="Logo" src="<?php echo e(image('it-asset.png')); ?>" class="h-35px app-sidebar-logo-default" />
		<img alt="Logo" src="<?php echo e(image('it-asset.png')); ?>" class="h-25px app-sidebar-logo-minimize" />
	</a>
	<!--end::Logo image-->
...
<!--end::Logo-->
<?php /**PATH D:\Important Materials\starterkit\resources\views/layout/partials/sidebar-layout/sidebar/_logo.blade.php ENDPATH**/ ?>