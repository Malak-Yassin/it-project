...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	<!--begin::Logo image-->
	<a href="/">
		<img alt="Logo" src="<?php echo e(image('logos/default-dark.svg')); ?>" class="h-25px app-sidebar-logo-default" />
		<img alt="Logo" src="<?php echo e(image('logos/default-small.svg')); ?>" class="h-20px app-sidebar-logo-minimize" />
	</a>
	<!--end::Logo image-->
...
<!--end::Logo-->
<?php /**PATH D:\Ibiidi Materials\Metronic Theme Laravel\laravel_demo1\starterkit\resources\views/layout/partials/sidebar-layout/sidebar/_logo.blade.php ENDPATH**/ ?>