	...
	<div class="card">
		...
		<div class="card-header">
			...
			<div class="card-toolbar">
				<!--begin::Menu-->
				<button type="button" class="btn btn-sm btn-icon btn-active-light-primary me-n3" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-end"><?php echo getIcon('setting-3', 'fs-2'); ?></button>
				<?php echo $__env->make('partials/menus/_menu-3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				<!--end::Menu-->
			</div>
			<!--end::Card toolbar-->
		</div>
...
<!--end::My apps--><?php /**PATH D:\Ibiidi Materials\Metronic Theme Laravel\laravel_demo1\starterkit\resources\views/partials/menus/_my-apps-menu.blade.php ENDPATH**/ ?>