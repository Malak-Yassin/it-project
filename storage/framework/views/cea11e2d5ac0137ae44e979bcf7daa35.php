			...
			<div class="col-sm-6">
				...
				<div class="d-flex flex-column h-100">
					...
					<div class="mb-7">
						...
						<div class="d-flex align-items-center flex-wrap d-grid gap-2">
							...
							<div class="d-flex align-items-center">
								<!--begin::Symbol-->
								<div class="symbol symbol-30px symbol-circle me-3">
									<span class="symbol-label bg-success"><?php echo getIcon('abstract-41', 'fs-5 text-white'); ?></span>
								</div>
								<!--end::Symbol-->
								<!--begin::Info-->
								<div class="m-0">
					...
					<div class="d-flex flex-stack mt-auto bd-highlight">
						...
						<!--end::Users group-->
						<!--begin::Actions-->
						<a href="#" class="d-flex align-items-center text-primary opacity-75-hover fs-6 fw-semibold">View Project <?php echo getIcon('exit-right-corner', 'fs-4 ms-1'); ?></a>
						<!--end::Actions-->
					</div>
					<!--end::Footer-->
				</div>
...
<!--end::Card widget 18-->
<?php /**PATH D:\Ibiidi Materials\Metronic Theme Laravel\laravel_demo1\starterkit\resources\views/partials/widgets/cards/_widget-18.blade.php ENDPATH**/ ?>