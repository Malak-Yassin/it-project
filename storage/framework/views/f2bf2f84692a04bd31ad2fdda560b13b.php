...
<div class="row">
	...
	<!--begin:Col-->
	<div class="col-lg-4">
		<img src="<?php echo e(image('stock/600x600/img-82.jpg')); ?>" class="rounded mw-100" alt="" />
	</div>
	<!--end:Col-->
</div>
<!--end:Row-->
<?php /**PATH D:\Ibiidi Materials\Metronic Theme Laravel\laravel_demo1\starterkit\resources\views/layout/partials/sidebar-layout/header/_menu/__pages-general.blade.php ENDPATH**/ ?>