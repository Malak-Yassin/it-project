	...
	<div class="card w-100 border-0 rounded-0" id="kt_drawer_chat_messenger">
		...
		<div class="card-header pe-5" id="kt_drawer_chat_messenger_header">
			...
			<div class="card-toolbar">
				<!--begin::Menu-->
				<div class="me-0">
					<button class="btn btn-sm btn-icon btn-active-color-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end"><?php echo getIcon('dots-square', 'fs-2'); ?></button>
					<!--begin::Menu 3-->
				...
				<!--end::Menu-->
				<!--begin::Close-->
				<div class="btn btn-sm btn-icon btn-active-color-primary" id="kt_drawer_chat_close"><?php echo getIcon('cross-square', 'fs-2'); ?></div>
				<!--end::Close-->
			</div>
			<!--end::Card toolbar-->
		</div>
		...
		<div class="card-footer pt-4" id="kt_drawer_chat_messenger_footer">
			...
			<div class="d-flex flex-stack">
				...
				<div class="d-flex align-items-center me-2">
					<button class="btn btn-sm btn-icon btn-active-light-primary me-1" type="button" data-bs-toggle="tooltip" title="Coming soon"><?php echo getIcon('paper-clip', 'fs-3'); ?></button>
					<button class="btn btn-sm btn-icon btn-active-light-primary me-1" type="button" data-bs-toggle="tooltip" title="Coming soon"><?php echo getIcon('cloud-add', 'fs-3'); ?></button>
				</div>
				<!--end::Actions-->
				<!--begin::Send-->
...
<!--end::Chat drawer--><?php /**PATH D:\Ibiidi Materials\Metronic Theme Laravel\laravel_demo1\starterkit\resources\views/partials/drawers/_chat-messenger.blade.php ENDPATH**/ ?>