...
<div class="card card-flush overflow-hidden h-lg-100">
	...
	<div class="card-header pt-5">
		...
		<div class="card-toolbar">
			...
			<!--end::Display range-->
			<?php echo getIcon('calendar-8', 'fs-1 ms-2 me-0'); ?></div>
			<!--end::Daterangepicker-->
		</div>
		<!--end::Toolbar-->
	</div>
...
<!--end::Chart widget 36--><?php /**PATH D:\Ibiidi Materials\Metronic Theme Laravel\laravel_demo1\starterkit\resources\views/partials/widgets/charts/_widget-36.blade.php ENDPATH**/ ?>