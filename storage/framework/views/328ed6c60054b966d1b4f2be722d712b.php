...
<div class="menu-active-bg pt-1 pb-3 px-3 py-lg-6 px-lg-6" data-kt-menu-dismiss="true">
	...
	<div class="row">
		...
		<div class="col-lg-6 mb-3 py-lg-3 pe-lg-8 d-flex align-items-center">
			<img src="<?php echo e(image('stock/900x600/45.jpg')); ?>" class="rounded mw-100" alt="" />
		</div>
		<!--end:Col-->
	</div>
	<!--end:Row-->
...
<!--end:Dashboards menu-->
<?php /**PATH D:\Ibiidi Materials\Metronic Theme Laravel\laravel_demo1\starterkit\resources\views/layout/partials/sidebar-layout/header/_menu/__layouts.blade.php ENDPATH**/ ?>